...
public class ActivityLoaderActivity extends Activity {
	...
	private void startExplicitActivation() {
		...
		Intent launchExplicitActiviity = new Intent(ActivityLoaderActivity.this, ExplicitlyLoadedActivity.class);
		startActivityForResult(launchExplicitActiviity, GET_TEXT_REQUEST_CODE );
	...
	private void startImplicitActivation() {
		...
		chooserIntent = Intent.createChooser(webIntent, "title");
